    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-projects">Display a listing of the projects.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-reports--id-">GET api/reports/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-reports--id-">
                                <a href="#endpoints-PUTapi-reports--id-">PUT api/reports/{id}</a>
                            </li>
...
<p>Must be at least 8 characters. Example: <code>OP&gt;@;4</code></p>
                    ...
                    <h2 id="endpoints-GETapi-projects">Display a listing of the projects.</h2>
...
<div class="bash-example">
    ...
    \"status\": \"consequatur\",
    \"start_date\": \"2025-04-08T21:43:27\",
    \"end_date\": \"2025-04-08T21:43:27\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="2025-04-08T21:43:27"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-04-08T21:43:27</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="progress"                data-endpoint="POSTapi-tasks"
               value="0"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="progress"                data-endpoint="PUTapi-tasks--id-"
               value="0"
               data-component="body">
    <br>
<p>Must be between 0 and 100. Example: <code>0</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="content"                data-endpoint="POSTapi-reports"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="project_id"                data-endpoint="POSTapi-reports"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the projects table. Example: <code>consequatur</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/reports/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the report. Example: <code>17</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PUTapi-reports--id-">PUT api/reports/{id}</h2>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-reports--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="content"                data-endpoint="PUTapi-reports--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="action"                data-endpoint="POSTapi-histories"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-histories"
               value="Dolores dolorum amet iste laborum eius est dolor."
               data-component="body">
    <br>
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="user_id"                data-endpoint="POSTapi-histories"
               value="consequatur"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/histories/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/histories/17"
);
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the history. Example: <code>17</code></p>
            </div>
                    </form>
